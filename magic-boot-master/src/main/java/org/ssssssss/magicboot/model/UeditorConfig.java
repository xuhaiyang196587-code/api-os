...
public class UeditorConfig {
	...
	private String imageUrlPrefix = RequestModule.getContextUrl();//图片访问路径前缀
	...
	private String fileUrlPrefix = RequestModule.getContextUrl(); /* 文件访问路径前缀 */
	...
	private String imageManagerUrlPrefix = RequestModule.getContextUrl(); /* 图片访问路径前缀 */
	...
	private String fileManagerUrlPrefix = RequestModule.getContextUrl(); /* 文件访问路径前缀 */
