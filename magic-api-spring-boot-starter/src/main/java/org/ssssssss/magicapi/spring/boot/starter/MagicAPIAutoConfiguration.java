...
import org.ssssssss.magicapi.hbase.web.MagicHbaseController;
	...
	public MagicConfiguration magicConfiguration(List<LanguageProvider> languageProviders,
		...
		if (base != null) {
			...
			mapping.registerController(magicWorkbenchController)
					...
					.registerController(new MagicRedisController(configuration))
					.registerController(new MagicTcpController(configuration))
					.registerController(new MagicESController(configuration))
					.registerController(new MagicHbaseController(configuration))
					.registerController(new MagicKafkaController(configuration))
					.registerController(new MagicMqttController(configuration))
