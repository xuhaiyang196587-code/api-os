...
import org.ssssssss.magicapi.task.TaskModule;
...
public class MagicAPITaskConfiguration implements MagicPluginConfiguration {
	 ...
	 */
	@Bean
	public TaskModule taskFunctions(@Qualifier("taskMagicDynamicRegistry") TaskMagicDynamicRegistry taskMagicDynamicRegistry) {
		return new TaskModule(taskMagicDynamicRegistry);
	}
